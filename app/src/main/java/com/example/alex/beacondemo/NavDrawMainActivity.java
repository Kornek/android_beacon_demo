package com.example.alex.beacondemo;
...
import layout.MonitoringFragment;
import layout.RangeFragment;
...
public class NavDrawMainActivity extends AppCompatActivity
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_range){
            ...
            fragmentManager.beginTransaction().replace(R.id.root, rangeFragment).addToBackStack("rangeFragment")
                    .commit();
        }
        if (id == R.id.nav_monitoring){
            FragmentManager fragmentManager = getFragmentManager();
            fragmentManager.beginTransaction().replace(R.id.root, monitoringFragment).addToBackStack("monitoringFragment")
                    .commit();
        }
